...
// ============================================
// WEEKLY CHART ARRAYS (module-level so both
// loadAnalytics() and updateChart() can see them)
// ============================================
...
let proteinData  = [0, 0, 0, 0, 0, 0, 0];
let carbsData    = [0, 0, 0, 0, 0, 0, 0];
let fatData      = [0, 0, 0, 0, 0, 0, 0];
...
export async function loadAnalytics() {
    ...
    try {
        ...
        // Reset weekly arrays in case loadAnalytics() runs more than once
        caloriesData = [0, 0, 0, 0, 0, 0, 0];
        proteinData  = [0, 0, 0, 0, 0, 0, 0];
        carbsData    = [0, 0, 0, 0, 0, 0, 0];
        fatData      = [0, 0, 0, 0, 0, 0, 0];
...
function createChart(labels, chartData, title) {
